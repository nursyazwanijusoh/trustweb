...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Activity Type Management</div>
                <div class="card-body">
                  <form method="POST" action="{{ route('admin.addat', [], false) }}">
                    @csrf
                ...
                <div class="card-body">
                  <h5 class="card-title">List of activity type</h5>
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $atask['descr'] }}</td>
                        <td>{{ $atask['remark'] }}</td>
                        <td><a href="{{ route('admin.delat', ['taskid' => $atask['id']], false) }}">Remove</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
